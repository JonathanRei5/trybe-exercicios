const pokemons = [
  {
    ...
    summary: 'Este Pokémon inteligente assa frutas duras com eletricidade para torná-las macias o suficiente para comer.',
  },
  {
    id: 4,
    name: 'Charmander',
    ...
    summary: 'A chama em sua cauda mostra a força de sua força vital. Se for fraca, a chama também queima fracamente.',
  },
  {
    id: 10,
    name: 'Caterpie',
    ...
    summary: 'Para proteção, ele libera um cheiro horrível das antenas em sua cabeça para afastar os inimigos.',
  },
  {
    id: 23,
    name: 'Ekans',
    ...
    summary: 'Ele pode soltar livremente sua mandíbula para engolir presas grandes inteiras. Ele pode se tornar muito pesado para se mover, no entanto.',
  },
  {
    id: 65,
    name: 'Alakazam',
    ...
    summary: 'Fechar os dois olhos aumenta todos os outros sentidos. Isso permite que ele use suas habilidades ao extremo.',
  },
  {
    id: 151,
    name: 'Mew',
    ...
    summary: 'Aparentemente, ele aparece apenas para aquelas pessoas que são puras de coração e têm um forte desejo de vê-lo.',
  },
  {
    id: 78,
    name: 'Rapidash',
    ...
    summary: 'A todo galope, seus quatro cascos mal tocam o chão porque ele se move incrivelmente rápido.',
  },
  {
    id: 143,
    name: 'Snorlax',
    ...
    summary: 'O que soa como seu grito pode ser, na verdade, seus roncos ou o ronco de sua barriga faminta.',
  },
  {
    id: 148,
    name: 'Dragonair',
    ...
    summary: 'Dizem que se emitir uma aura de todo o corpo, o clima começará a mudar instantaneamente.',
  },
];
